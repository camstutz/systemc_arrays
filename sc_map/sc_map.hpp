...
//class sc_map : public sc_map_base
//{
////    sc_map(const sc_module_name name, const std::vector<key_type> key_vector);
////    template <typename config_T>
////    sc_map(const sc_module_name name, const std::vector<key_type> key_vector, const config_T configuration);
//};
