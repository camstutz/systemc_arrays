        ...
        iterate_X(iterate_X)
{
    ...
    if ( (sc_map_sq->start_id_X+sc_map_sq->size_X() <= X_pos) || (sc_map_sq->start_id_Y+sc_map_sq->size_Y() <= Y_pos) )
    {
        // todo: warning ?
        this->set_vect_pos(sc_map_sq->size());
    }
    else if ( (sc_map_sq->start_id_X > X_pos) || (sc_map_sq->start_id_Y > Y_pos) )
    {
